...
func (c *Commands) defaultCommands() []*CommandItem {
	commands := []*CommandItem{
		...
		NewCommandItem(c.com.Styles, "tickets", "Work Items", "", ActionNavigate{View: "tickets"}),
		NewCommandItem(c.com.Styles, "jjhub_changes", "JJHub Changes", "", ActionNavigate{View: "changes"}),
		...
		NewCommandItem(c.com.Styles, "landings", "Landings", "", ActionNavigate{View: "landings"}),
		NewCommandItem(c.com.Styles, "workspaces", "Workspaces", "", ActionNavigate{View: "workspaces"}),
	...
	commands = append(commands,
		...
		NewCommandItem(c.com.Styles, "tickets", "Work Items", "", ActionOpenTicketsView{}),
