...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View Codeplane logs",
	Long:  `View the logs generated by Codeplane. This command allows you to inspect log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Config().Options.DataDirectory, "logs", "codeplane.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a Codeplane project. No logs found.")
			return nil
		}
